  ...
  return (
    <div className="border-b border-neutral-900 pb-24">
      ...
      >
        ...
        >
          <RiVuejsFill className="text-7xl  text-[#42b883] "></RiVuejsFill>
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <ImWordpress className="text-7xl "></ImWordpress>
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <DiRedis className="text-7xl text-red-500"></DiRedis>
        </motion.div>
        <motion.div
          variants={iconVariants(2)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <BiLogoPostgresql className="text-7xl text-sky-500"></BiLogoPostgresql>
        </motion.div>
      </motion.div>
    </div>
  );
